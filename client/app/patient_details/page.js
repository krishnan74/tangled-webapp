...
import Precipitation from "../../components/patient_details/SugarLevel";
import Wind from "../../components/patient_details/HeartRate";
        ...
        <div className="left_section">
          ...
          <div className="city_div">
            <div className="newyork">
              ...
              <p className=" left_text">Chennai TamilNadu</p>
        ...
        <div className="right_section">
          <div className="user_detail mt-8 mb-0">
            <div className="user_detail_text ml-10">
              <p className="text-s font-bold">Name: Isabella!</p>
